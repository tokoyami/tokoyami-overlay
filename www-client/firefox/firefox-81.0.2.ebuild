...
IUSE="clang cpu_flags_arm_neon dbus debug eme-free geckodriver +gmp-autoupdate
	hardened hwaccel jack lto +openh264 pgo pulseaudio alsa webrtc screencast selinux
...
CDEPEND="
	...
	kernel_linux? ( !pulseaudio? ( alsa? ( media-libs/alsa-lib ) ) )
...
src_configure() {
	...
	if use kernel_linux && ! use pulseaudio && use alsa ; then
